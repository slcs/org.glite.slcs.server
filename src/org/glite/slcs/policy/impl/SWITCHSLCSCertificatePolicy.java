/*
 * $Id: SWITCHSLCSCertificatePolicy.java,v 1.1 2006/10/27 12:11:24 vtschopp Exp $
 * 
...
public class SWITCHSLCSCertificatePolicy implements CertificatePolicy {
    ...
    public void init(SLCSServerConfiguration config) throws SLCSException {
        ...
        List certificateExtensionNames= config.getList("SLCSComponentConfiguration.CertificatePolicy.CertificateExtensions.CertificateExtension[@id]");
        ...
        for (int i= 0; extensionNames.hasNext(); i++) {
            ...
            String extensionValues= config.getString("SLCSComponentConfiguration.CertificatePolicy.CertificateExtensions.CertificateExtension("
                    + i + ")");
    ...
    public boolean isCertificateRequestValid(CertificateRequest request,
        ...
        if (!certificateRequestExtensions.containsAll(requiredCertificateExtensions)) {
            LOG.error("CertificateSigningRequest does not contains all required CertificateExtensions");
            return false;
